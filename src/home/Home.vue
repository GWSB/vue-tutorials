<template>
    <div>
      <div class="hero tac">
        <h1>VueJS Tutorials</h1>
        <h3>Learn VueJS. Teach VueJS. Build stuff.</h3>
        <br>
        <div>
          <a class="btn  btn--light hint--bottom  big-create-btn" aria-label="Lets create" @click="onCreateClick">Begin</a>
          <a class="btn  btn--light hint--bottom  big-create-btn" aria-label="Get the source" href="https://github.com/GWSB/vuejs-tutorials">
