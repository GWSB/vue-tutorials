  ...
  <div class="main-wrap">
    <header>
      <a class="header__logo-wrap" v-link="{ path: '/' }">
        ...
        <h3 style="display:inline-block;margin:0;color:white">VueJS Tutorials</h3>
      </a>
    ...
    <footer>
      <div>
        &copy; 2017 Tim Dodge - Open Source
      </div>
      <div style="display:flex;align-items:center;">
        <a href="mailto:timldodge@gmail.com" class="footer-link">email</a>
        <a v-link="{ path: '/about' }" class="footer-link">about</a>
        <a href="https://twitter.com/timdodgeco" target="_blank" class="footer-link">
